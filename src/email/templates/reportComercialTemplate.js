  ...
  const rows = report
    .map(
      ...
      <tr class="table__row">
        ...
        <td class="amount center">S/${entry.letycash.toFixed(2)}</td>
    ...
    <html>
      ...
      <body>
        <div class="report-container">
          ...
          <h1 class="report-title">Reporte de Suscripción para Comercial</h1>
          <p class="report-subtitle">Detalle de horas restantes y Letycash del periodo</p>
